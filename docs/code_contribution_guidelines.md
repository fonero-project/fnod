...
reason, the fnod suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire fnod
...
One of the major design goals of all core fnod packages is to aim for complete
...
- If a commit modifies a component in any of the packages besides the main
  package use the package name as the commit prefix (eg. `fnojson`).
...
contributions.  This is how to get your changes into fnod.
...
Rejoice as you will now be listed as a [contributor](https://github.com/fonero-project/fnod/graphs/contributors)!
...
[ISC license](https://github.com/fonero-project/fnod/blob/master/LICENSE).  This is
the same license as all of the code in the fnod suite.
