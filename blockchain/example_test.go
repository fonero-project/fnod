...
// overview documentation describes, this includes all of the Fonero consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := fnoutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Fonero block chain.
