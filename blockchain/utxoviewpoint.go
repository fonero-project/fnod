...
func (view *UtxoViewpoint) AddTxOuts(tx *fnoutil.Tx, blockHeight int64, blockIndex uint32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *fnoutil.Tx, blockHeight int64, blockIndex uint32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *fnoutil.Block, stxos []spentTxOut, stakeTree bool) error {
...
// information.
func (view *UtxoViewpoint) disconnectRegularTransactions(block *fnoutil.Block, stxos []spentTxOut) error {
...
// of the txos spent by those same transactions by using the provided spent txo
// information.
func (view *UtxoViewpoint) disconnectStakeTransactions(block *fnoutil.Block, stxos []spentTxOut) error {
...
// information.
//func (view *UtxoViewpoint) disconnectDisapprovedBlock(db database.DB, block *fnoutil.Block, stxos []spentTxOut) error {
func (view *UtxoViewpoint) disconnectDisapprovedBlock(db database.DB, block *fnoutil.Block) error {
...
func (view *UtxoViewpoint) connectBlock(db database.DB, block, parent *fnoutil.Block, stxos *[]spentTxOut) error {
...
// panic.
func (view *UtxoViewpoint) disconnectBlock(db database.DB, block, parent *fnoutil.Block, stxos []spentTxOut) error {
	// Sanity check the correct number of stxos are provided.
	if len(stxos) != countSpentOutputs(block) {
		panicf("provided %v stxos for block %v (height %v) which spends %v "+
			"outputs", len(stxos), block.Hash(), block.MsgBlock().Header.Height,
...
func (view *UtxoViewpoint) addRegularInputUtxos(block *fnoutil.Block) viewFilteredSet {
...
func (view *UtxoViewpoint) fetchRegularInputUtxos(db database.DB, block *fnoutil.Block) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *fnoutil.Block) error {
	// Add any outputs of transactions in the regular tree of the block that are
	// referenced by inputs of transactions that are located later in the tree
...
func (b *BlockChain) FetchUtxoView(tx *fnoutil.Tx, includePrevRegularTxns bool) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
