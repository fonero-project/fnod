...
func BlockOneCoinbasePaysTokens(tx *fnoutil.Tx, params *chaincfg.Params) error {
	...
	for i, txout := range tx.MsgTx().TxOut {
		...
		addrLedger, err := fnoutil.DecodeAddress(ledger[i].Address)
		if err != nil {
			return err
		}
...
func CoinbasePaysTax(subsidyCache *SubsidyCache, tx *fnoutil.Tx, height int64, voters uint16, params *chaincfg.Params) error {
...
func CalculateAddedSubsidy(block, parent *fnoutil.Block) int64 {
	var subsidy int64
