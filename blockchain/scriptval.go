...
func ValidateTransactionScripts(tx *fnoutil.Tx, utxoView *UtxoViewpoint, flags txscript.ScriptFlags, sigCache *txscript.SigCache) error {
...
func checkBlockScripts(block *fnoutil.Block, utxoView *UtxoViewpoint, txTree bool,
