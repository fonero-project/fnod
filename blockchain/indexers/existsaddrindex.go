...
func (idx *ExistsAddrIndex) ExistsAddress(addr fnoutil.Address) (bool, error) {
...
func (idx *ExistsAddrIndex) ExistsAddresses(addrs []fnoutil.Address) ([]bool, error) {
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) ConnectBlock(dbTx database.Tx, block, parent *fnoutil.Block, view *blockchain.UtxoViewpoint) error {
	...
	blockTxns := make([]*fnoutil.Tx, 0, len(block.Transactions())+
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) DisconnectBlock(dbTx database.Tx, block, parent *fnoutil.Block, view *blockchain.UtxoViewpoint) error {
