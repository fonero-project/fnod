...
func TestSStx(t *testing.T) {
	var sstx = fnoutil.NewTx(sstxMsgTx)
	...
	sstx = fnoutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = fnoutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = fnoutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = fnoutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = fnoutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = fnoutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = fnoutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = fnoutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = fnoutil.NewTx(&tx)
	...
	var sstxWrongPrefix = fnoutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = fnoutil.NewTx(ssgenMsgTx)
	...
	ssgen = fnoutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = fnoutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = fnoutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = fnoutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = fnoutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = fnoutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = fnoutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = fnoutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = fnoutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = fnoutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = fnoutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = fnoutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = fnoutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = fnoutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = fnoutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = fnoutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = fnoutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = fnoutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = fnoutil.NewTx(&tx)
