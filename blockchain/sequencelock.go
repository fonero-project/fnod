...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *fnoutil.Tx, view *UtxoViewpoint, isActive bool) (*SequenceLock, error) {
...
func (b *BlockChain) CalcSequenceLock(tx *fnoutil.Tx, view *UtxoViewpoint) (*SequenceLock, error) {
	b.chainLock.Lock()
