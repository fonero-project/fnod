...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/fonero-project/fnod/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/fonero-project/fnod/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/fonero-project/fnod/blockchain/chaingen
```
