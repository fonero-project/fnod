...
// Peer provides a basic concurrent safe Fonero peer for handling fnocoin
...
// callbacks for handling Fonero protocol messages.
//
...
// newPeerBase returns a new base Fonero peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound Fonero peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound Fonero peer.
