...
```bash
$ go get -u github.com/fonero-project/fnod/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/fonero-project/fnod/peer#example-package--NewOutboundPeer)  
