...
/*
Package peer provides a common base for creating and managing Fonero network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the Fonero wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling Fonero protocol messages
...
(https://godoc.org/github.com/fonero-project/fnod/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
