...
/*
fnod is a full-node Fonero implementation written in Go.

The default options are sane for most users.  This means fnod will work 'out of
...
parsed when fnod starts up.  By default, the configuration file is located at
~/.fnod/fnod.conf on POSIX-style operating systems and %LOCALAPPDATA%\fnod\fnod.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in FNO/kB to be
      ...
      --altdnsnames:        Specify additional dns names to use when
                            ...
                            [supports FNOD_ALT_DNSNAMES environment variable]
