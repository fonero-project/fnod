...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, FNOD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawsstx-amount--desc":  "The destination address as the key and the amount in FNO as the value",
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in FNO as the value",
	...
	"scriptpubkeyresult-addresses": "The Fonero addresses associated with this script",
	"scriptpubkeyresult-commitamt": "The ticket commitment value if the script is for a staking commitment",

	// Vout help.
	"vout-value":        "The amount in FNO",
	...
	"decodescriptresult-addresses": "The Fonero addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (fnod extension)",
	...
	"getcurrentnet--synopsis": "Get Fonero network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in FNO/KB",
	...
	"infowalletresult-balance":         "The total Fonero balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in FNO/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in fnocoin",
	...
	"gettxoutresult-value":         "The transaction amount in FNO",
	...
	"searchrawtransactions-address":     "The Fonero address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (fnod does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown fnod.",
	"stop--result0":  "The string 'fnod stopping.'",
	...
	"validateaddresschainresult-address": "The Fonero address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Fonero address to validate",
	...
	"verifymessage-address":   "The Fonero address to use for the signature",
	...
	// -------- Fonero-specific help --------

	// EstimateFee help.
	"estimatefee--synopsis": "Returns the estimated fee in fno/kb.",
	"estimatefee-numblocks": "(unused)",
	"estimatefee--result0":  "Estimated fee.",

	// EstimateSmartFee help.
	"estimatesmartfee--synopsis":     "Returns the estimated fee using the historical fee data in fno/kb.",
	...
	"estimatesmartfee--result0":      "Estimated fee rate (in FNO/KB).",
	...
	// TicketFeeInfo help.
	"ticketfeeinfo--synopsis":            "Get various information about ticket fees from the mempool, blocks, and difficulty windows (units: FNO/kB)",
	...
	"ticketfeeinforesult-feeinfomempool": "Ticket fee information for all tickets in the mempool (units: FNO/kB)",
	"ticketfeeinforesult-feeinfoblocks":  "Ticket fee information for a given list of blocks descending from the chain tip (units: FNO/kB)",
	"ticketfeeinforesult-feeinfowindows": "Ticket fee information for a window period where the stake difficulty was the same (units: FNO/kB)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*fnojson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*fnojson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatesmartfee":      {(*float64)(nil)},
	"estimatestakediff":     {(*fnojson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]fnojson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*fnojson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*fnojson.GetBlockVerboseResult)(nil)},
	"getblockchaininfo":     {(*fnojson.GetBlockChainInfoResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*fnojson.GetBlockHeaderVerboseResult)(nil)},
	"getblocksubsidy":       {(*fnojson.GetBlockSubsidyResult)(nil)},
	"getblocktemplate":      {(*fnojson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getcfilter":            {(*string)(nil)},
	"getcfilterheader":      {(*string)(nil)},
	"getchaintips":          {(*[]fnojson.GetChainTipsResult)(nil)},
	"getconnectioncount":    {(*int32)(nil)},
	"getcurrentnet":         {(*uint32)(nil)},
	"getdifficulty":         {(*float64)(nil)},
	"getstakedifficulty":    {(*fnojson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*fnojson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*fnojson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*fnojson.GetHeadersResult)(nil)},
	"getinfo":               {(*fnojson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*fnojson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*fnojson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*fnojson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]fnojson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*fnojson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*fnojson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*fnojson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*fnojson.GetVoteInfoResult)(nil)},
	"getwork":               {(*fnojson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*fnojson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*fnojson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]fnojson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*fnojson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*fnojson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*fnojson.TxFeeInfoResult)(nil)},
	"validateaddress":       {(*fnojson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]fnojson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*fnojson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := fnojson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := fnojson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
