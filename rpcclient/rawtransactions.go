...
func (r FutureGetRawTransactionResult) Receive() (*fnoutil.Tx, error) {
	...
	return fnoutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := fnojson.NewGetRawTransactionCmd(hash, fnojson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*fnoutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*fnojson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult fnojson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := fnojson.NewGetRawTransactionCmd(hash, fnojson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*fnojson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*fnojson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := fnojson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*fnojson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []fnojson.TransactionInput,
	amounts map[fnoutil.Address]fnoutil.Amount, lockTime *int64, expiry *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCoin()
	}
	cmd := fnojson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime, expiry)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []fnojson.TransactionInput,
	amounts map[fnoutil.Address]fnoutil.Amount, lockTime *int64, expiry *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	...
	CommitAmt  fnoutil.Amount
	ChangeAddr fnoutil.Address
	ChangeAmt  fnoutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []fnojson.SStxInput,
	amount map[fnoutil.Address]fnoutil.Amount,
	...
	convertedCouts := make([]fnojson.SStxCommitOut, len(couts))
	...
	cmd := fnojson.NewCreateRawSStxCmd(inputs,
		convertedAmt,
		convertedCouts)
...
// and sending to the provided addresses.
func (c *Client) CreateRawSStx(inputs []fnojson.SStxInput,
	amount map[fnoutil.Address]fnoutil.Amount,
...
func (c *Client) CreateRawSSGenTxAsync(inputs []fnojson.TransactionInput,
	votebits uint16) FutureCreateRawSSGenTxResult {

	cmd := fnojson.NewCreateRawSSGenTxCmd(inputs, votebits)
	return c.sendCmd(cmd)
}

// CreateRawSSGenTx returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawSSGenTx(inputs []fnojson.TransactionInput,
...
func (c *Client) CreateRawSSRtxAsync(inputs []fnojson.TransactionInput, fee fnoutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
	cmd := fnojson.NewCreateRawSSRtxCmd(inputs, &feeF64)
	return c.sendCmd(cmd)
}

// CreateRawSSRtx returns a new SSR transactionm (revoking an sstx).
func (c *Client) CreateRawSSRtx(inputs []fnojson.TransactionInput, fee fnoutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := fnojson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult fnojson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := fnojson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []fnojson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := fnojson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []fnojson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := fnojson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []fnojson.RawTxInput, privKeysWIF []string,
	...
	cmd := fnojson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		fnojson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawSSGenTxAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := fnojson.NewSignRawTransactionCmd(txHex, &[]fnojson.RawTxInput{},
		nil, fnojson.String("ssgen"))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address fnoutil.Address, skip,
	count int, reverse bool,
	filterAddrs []string) FutureSearchRawTransactionsResult {

	addr := address.EncodeAddress()
	verbose := fnojson.Int(0)
	prevOut := fnojson.Int(0)
	cmd := fnojson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address fnoutil.Address, skip, count int,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*fnojson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*fnojson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address fnoutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs *[]string) FutureSearchRawTransactionsVerboseResult {

	addr := address.EncodeAddress()
	verbose := fnojson.Int(1)
	prevOut := fnojson.Int(0)
	if includePrevOut {
		prevOut = fnojson.Int(1)
	}
	cmd := fnojson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
		prevOut, &reverse, filterAddrs)
	return c.sendCmd(cmd)
...
func (c *Client) SearchRawTransactionsVerbose(address fnoutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs []string) ([]*fnojson.SearchRawTransactionsResult, error) {
