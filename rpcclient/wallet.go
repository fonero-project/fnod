...
func (r FutureGetTransactionResult) Receive() (*fnojson.GetTransactionResult, error) {
	...
	var getTx fnojson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := fnojson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*fnojson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]fnojson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []fnojson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := fnojson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]fnojson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := fnojson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]fnojson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := fnojson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]fnojson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]fnojson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []fnojson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := fnojson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := fnojson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := fnojson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []fnoutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := fnojson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]fnojson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]fnojson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]fnojson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []fnoutil.Address) ([]fnojson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*fnojson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult fnojson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = fnojson.String(blockHash.String())
	}

	cmd := fnojson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*fnojson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := fnojson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*fnojson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]fnojson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = fnojson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
			Tree: op.Tree,
		}
	}
	cmd := fnojson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []fnojson.TransactionInput
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // Fonero TODO
	}
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := fnojson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressAsync(address fnoutil.Address, amount fnoutil.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewSendToAddressCmd(addr, amount.ToCoin(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address fnoutil.Address, amount fnoutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address fnoutil.Address,
	amount fnoutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := fnojson.NewSendToAddressCmd(addr, amount.ToCoin(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address fnoutil.Address, amount fnoutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress fnoutil.Address, amount fnoutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := fnojson.NewSendFromCmd(fromAccount, addr, amount.ToCoin(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress fnoutil.Address, amount fnoutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress fnoutil.Address, amount fnoutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := fnojson.NewSendFromCmd(fromAccount, addr, amount.ToCoin(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress fnoutil.Address, amount fnoutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress fnoutil.Address, amount fnoutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress fnoutil.Address,
	amount fnoutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[fnoutil.Address]fnoutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToCoin()
	}
	cmd := fnojson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[fnoutil.Address]fnoutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[fnoutil.Address]fnoutil.Amount,
	...
	cmd := fnojson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[fnoutil.Address]fnoutil.Amount, minConfirms int,
...
func (c *Client) PurchaseTicketAsync(fromAccount string,
	spendLimit fnoutil.Amount, minConf *int, ticketAddress fnoutil.Address,
	numTickets *int, poolAddress fnoutil.Address, poolFees *fnoutil.Amount,
	expiry *int, ticketFee *fnoutil.Amount) FuturePurchaseTicketResult {
	...
	cmd := fnojson.NewPurchaseTicketCmd(fromAccount, spendLimit.ToCoin(),
		&minConfVal, &ticketAddrStr, &numTicketsVal, &poolAddrStr,
		&poolFeesFloat, &expiryVal, fnojson.String(""), &ticketFeeFloat)
...
func (c *Client) PurchaseTicket(fromAccount string,
	spendLimit fnoutil.Amount, minConf *int, ticketAddress fnoutil.Address,
	numTickets *int, poolAddress fnoutil.Address, poolFees *fnoutil.Amount,
	expiry *int, ticketChange *bool, ticketFee *fnoutil.Amount) ([]*chainhash.Hash, error) {
...
func (r FutureAddMultisigAddressResult) Receive() (fnoutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return fnoutil.DecodeAddress(addr)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []fnoutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := fnojson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []fnoutil.Address, account string) (fnoutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*fnojson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes fnojson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []fnoutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := fnojson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []fnoutil.Address) (*fnojson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := fnojson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (fnoutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := fnojson.NewGetNewAddressCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNewAddressGapPolicyAsync(account string, gapPolicy GapPolicy) FutureGetNewAddressResult {
	cmd := fnojson.NewGetNewAddressCmd(&account, (*string)(&gapPolicy))
	return c.sendCmd(cmd)
}

// GetNewAddress returns a new address.
func (c *Client) GetNewAddress(account string) (fnoutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (fnoutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (fnoutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := fnojson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawChangeAddress(account string) (fnoutil.Address, error) {
...
// Fonero address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (fnoutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := fnojson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}

// GetAccountAddress returns the current Fonero address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (fnoutil.Address, error) {
...
func (c *Client) GetAccountAsync(address fnoutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address fnoutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]fnoutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]fnoutil.Address, 0, len(addrStrings))
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := fnojson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}

// GetAddressesByAccount returns the list of addresses associated with the
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]fnoutil.Address, error) {
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := fnojson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
// about the given Fonero address.
func (r FutureValidateAddressResult) Receive() (*fnojson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult fnojson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address fnoutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given Fonero address.
func (c *Client) ValidateAddress(address fnoutil.Address) (*fnojson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := fnojson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := fnojson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]fnoutil.Amount)
	for k, v := range accounts {
		amount, err := fnoutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := fnojson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]fnoutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := fnojson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]fnoutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (*fnojson.GetBalanceResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var balance fnojson.GetBalanceResult
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := fnojson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (*fnojson.GetBalanceResult, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := fnojson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (*fnojson.GetBalanceResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := fnoutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := fnojson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (fnoutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := fnojson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (fnoutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := fnojson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (fnoutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address fnoutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address fnoutil.Address) (fnoutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address fnoutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address fnoutil.Address, minConfirms int) (fnoutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]fnojson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []fnojson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := fnojson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]fnojson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := fnojson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]fnojson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := fnojson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]fnojson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]fnojson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []fnojson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := fnojson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]fnojson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := fnojson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]fnojson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := fnojson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]fnojson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := fnojson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := fnojson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address fnoutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address fnoutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address fnoutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address fnoutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*fnoutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return fnoutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address fnoutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := fnojson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address fnoutil.Address) (*fnoutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *fnoutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := fnojson.NewImportPrivKeyCmd(wif, nil, nil, nil)
	return c.sendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *fnoutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *fnoutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := fnojson.NewImportPrivKeyCmd(wif, &label, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *fnoutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *fnoutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := fnojson.NewImportPrivKeyCmd(wif, &label, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *fnoutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *fnoutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := fnojson.NewImportPrivKeyCmd(wif, &label, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *fnoutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) ImportScriptAsync(script []byte) FutureImportScriptResult {
	...
	cmd := fnojson.NewImportScriptCmd(scriptStr, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanAsync(script []byte, rescan bool) FutureImportScriptResult {
	...
	cmd := fnojson.NewImportScriptCmd(scriptStr, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanFromAsync(script []byte, rescan bool, scanFrom int) FutureImportScriptResult {
	...
	cmd := fnojson.NewImportScriptCmd(scriptStr, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountAddressIndexAsync(account string, branch uint32) FutureAccountAddressIndexResult {
	cmd := fnojson.NewAccountAddressIndexCmd(account, int(branch))
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountSyncAddressIndexAsync(account string, branch uint32, index int) FutureAccountSyncAddressIndexResult {
	cmd := fnojson.NewAccountSyncAddressIndexCmd(account, int(branch), index)
	return c.sendCmd(cmd)
}
...
func (c *Client) RevokeTicketsAsync() FutureRevokeTicketsResult {
	cmd := fnojson.NewRevokeTicketsCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicketAsync(rawHex string) FutureAddTicketResult {
	cmd := fnojson.NewAddTicketCmd(rawHex)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicket(ticket *fnoutil.Tx) error {
...
func (r FutureFundRawTransactionResult) Receive() (*fnojson.FundRawTransactionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var infoRes fnojson.FundRawTransactionResult
...
func (c *Client) FundRawTransactionAsync(rawhex string, fundAccount string, options fnojson.FundRawTransactionOptions) FutureFundRawTransactionResult {
	cmd := fnojson.NewFundRawTransactionCmd(rawhex, fundAccount, &options)
	return c.sendCmd(cmd)
}

// FundRawTransaction Add inputs to a transaction until it has enough
// in value to meet its out value.
func (c *Client) FundRawTransaction(rawhex string, fundAccount string, options fnojson.FundRawTransactionOptions) (*fnojson.FundRawTransactionResult, error) {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGenerateVoteResult) Receive() (*fnojson.GenerateVoteResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes fnojson.GenerateVoteResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GenerateVoteAsync(blockHash *chainhash.Hash, height int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) FutureGenerateVoteResult {
	cmd := fnojson.NewGenerateVoteCmd(blockHash.String(), height, sstxHash.String(), voteBits, voteBitsExt)
	return c.sendCmd(cmd)
}

// GenerateVote returns hex of an SSGen.
func (c *Client) GenerateVote(blockHash *chainhash.Hash, height int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) (*fnojson.GenerateVoteResult, error) {
	return c.GenerateVoteAsync(blockHash, height, sstxHash, voteBits, voteBitsExt).Receive()
}

// NOTE: While getinfo is implemented here (in wallet.go), a fnod chain server
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGetInfoResult) Receive() (*fnojson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes fnojson.InfoWalletResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetInfo() (*fnojson.InfoWalletResult, error) {
...
func (r FutureGetStakeInfoResult) Receive() (*fnojson.GetStakeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes fnojson.GetStakeInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeInfoAsync() FutureGetStakeInfoResult {
	cmd := fnojson.NewGetStakeInfoCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetStakeInfo() (*fnojson.GetStakeInfoResult, error) {
...
func (r FutureGetTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	var tixRes fnojson.GetTicketsResult
...
func (c *Client) GetTicketsAsync(includeImmature bool) FutureGetTicketsResult {
	cmd := fnojson.NewGetTicketsCmd(includeImmature)
	return c.sendCmd(cmd)
}
...
func (r FutureListScriptsResult) Receive() ([][]byte, error) {
	...
	var resScr fnojson.ListScriptsResult
...
func (c *Client) SetTicketFeeAsync(fee fnoutil.Amount) FutureSetTicketFeeResult {
	cmd := fnojson.NewSetTicketFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTicketFee sets the ticket fee per KB amount.
func (c *Client) SetTicketFee(fee fnoutil.Amount) error {
...
func (c *Client) SetTxFeeAsync(fee fnoutil.Amount) FutureSetTxFeeResult {
	cmd := fnojson.NewSetTxFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTxFee sets the transaction fee per KB amount.
func (c *Client) SetTxFee(fee fnoutil.Amount) error {
...
// Receive waits for the response promised by the future.
func (r FutureGetVoteChoicesResult) Receive() (*fnojson.GetVoteChoicesResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var choicesRes fnojson.GetVoteChoicesResult
...
func (c *Client) SetVoteChoiceAsync(agendaID, choiceID string) FutureSetVoteChoiceResult {
	cmd := fnojson.NewSetVoteChoiceCmd(agendaID, choiceID)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureStakePoolUserInfoResult) Receive() (*fnojson.StakePoolUserInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes fnojson.StakePoolUserInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) StakePoolUserInfoAsync(addr fnoutil.Address) FutureStakePoolUserInfoResult {
	cmd := fnojson.NewStakePoolUserInfoCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}

// StakePoolUserInfo returns a list of tickets and information about them
// that are paying to the passed address.
func (c *Client) StakePoolUserInfo(addr fnoutil.Address) (*fnojson.StakePoolUserInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureTicketsForAddressResult) Receive() (*fnojson.TicketsForAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes fnojson.TicketsForAddressResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) TicketsForAddressAsync(addr fnoutil.Address) FutureTicketsForAddressResult {
	cmd := fnojson.NewTicketsForAddressCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}
...
// owned by the wallet.
func (c *Client) TicketsForAddress(addr fnoutil.Address) (*fnojson.TicketsForAddressResult, error) {
...
// Receive waits for the response promised by the future and returns the stake
// info provided by the server.
func (r FutureWalletInfoResult) Receive() (*fnojson.WalletInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes fnojson.WalletInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletInfoAsync() FutureWalletInfoResult {
	cmd := fnojson.NewWalletInfoCmd()
	return c.sendCmd(cmd)
}

// WalletInfo returns wallet global state info for a given wallet.
func (c *Client) WalletInfo() (*fnojson.WalletInfoResult, error) {
	return c.WalletInfoAsync().Receive()
}

// TODO(davec): Implement
// backupwallet (NYI in fnowallet)
// encryptwallet (Won't be supported by fnowallet since it's always encrypted)
// getwalletinfo (NYI in fnowallet or fnojson)
// listaddressgroupings (NYI in fnowallet)
// listreceivedbyaccount (NYI in fnowallet)

// DUMP
// importwallet (NYI in fnowallet)
// dumpwallet (NYI in fnowallet)
