...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := fnojson.NewGenerateCmd(numBlocks)
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := fnojson.NewSetGenerateCmd(enable, &numCPUs)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := fnojson.NewGetHashesPerSecCmd()
	return c.sendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*fnojson.GetMiningInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult fnojson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := fnojson.NewGetMiningInfoCmd()
	return c.sendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*fnojson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := fnojson.NewGetNetworkHashPSCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := fnojson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := fnojson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.sendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*fnojson.GetWorkResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result fnojson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWork() (*fnojson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := fnojson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockTemplate) Receive() (*fnojson.GetBlockTemplateResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result.
	var gbt fnojson.GetBlockTemplateResult
...
func (c *Client) GetBlockTemplateAsync(req *fnojson.TemplateRequest) FutureGetBlockTemplate {
	cmd := fnojson.NewGetBlockTemplateCmd(req)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockTemplate(req *fnojson.TemplateRequest) (*fnojson.GetBlockTemplateResult, error) {
...
func (c *Client) SubmitBlockAsync(block *fnoutil.Block, options *fnojson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := fnojson.NewSubmitBlockCmd(blockHex, options)
	return c.sendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the Fonero network.
func (c *Client) SubmitBlock(block *fnoutil.Block, options *fnojson.SubmitBlockOptions) error {
