...
//
// NOTE: This is a fnod extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := fnojson.NewDebugLevelCmd(levelSpec)
	return c.sendCmd(cmd)
}
...
func (r FutureEstimateStakeDiffResult) Receive() (*fnojson.EstimateStakeDiffResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var est fnojson.EstimateStakeDiffResult
...
func (c *Client) EstimateStakeDiffAsync(tickets *uint32) FutureEstimateStakeDiffResult {
	cmd := fnojson.NewEstimateStakeDiffCmd(tickets)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) EstimateStakeDiff(tickets *uint32) (*fnojson.EstimateStakeDiffResult, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressAsync(address fnoutil.Address) FutureExistsAddressResult {
	cmd := fnojson.NewExistsAddressCmd(address.EncodeAddress())
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) ExistsAddress(address fnoutil.Address) (bool, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressesAsync(addresses []fnoutil.Address) FutureExistsAddressesResult {
	addrsStr := make([]string, len(addresses))
	for i := range addresses {
		addrsStr[i] = addresses[i].EncodeAddress()
	}

	cmd := fnojson.NewExistsAddressesCmd(addrsStr)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) ExistsAddresses(addresses []fnoutil.Address) (string, error) {
...
func (c *Client) ExistsMissedTicketsAsync(hashes []*chainhash.Hash) FutureExistsMissedTicketsResult {
	...
	cmd := fnojson.NewExistsMissedTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsExpiredTicketsAsync(hashes []*chainhash.Hash) FutureExistsExpiredTicketsResult {
	...
	cmd := fnojson.NewExistsExpiredTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketAsync(hash *chainhash.Hash) FutureExistsLiveTicketResult {
	cmd := fnojson.NewExistsLiveTicketCmd(hash.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketsAsync(hashes []*chainhash.Hash) FutureExistsLiveTicketsResult {
	...
	cmd := fnojson.NewExistsLiveTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsMempoolTxsAsync(hashes []*chainhash.Hash) FutureExistsMempoolTxsResult {
	...
	cmd := fnojson.NewExistsMempoolTxsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := fnojson.NewExportWatchingWalletCmd(&account, fnojson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by fnowallet to enable a wallet which does not have the private keys
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int64, error) {
	...
	var bestBlock fnojson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := fnojson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := fnojson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// getheaders result.
func (r FutureGetHeadersResult) Receive() (*fnojson.GetHeadersResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr fnojson.GetHeadersResult
...
func (c *Client) GetHeadersAsync(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := fnojson.NewGetHeadersCmd(hex.EncodeToString(concatenatedLocators),
		hashStop.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHeaders(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) (*fnojson.GetHeadersResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeDifficultyResult) Receive() (*fnojson.GetStakeDifficultyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a fnojson.GetStakeDifficultyResult.
	var gsdr fnojson.GetStakeDifficultyResult
...
func (c *Client) GetStakeDifficultyAsync() FutureGetStakeDifficultyResult {
	cmd := fnojson.NewGetStakeDifficultyCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionsResult) Receive() (*fnojson.GetStakeVersionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a fnojson.GetStakeVersionsResult.
	var gsvr fnojson.GetStakeVersionsResult
...
func (c *Client) GetStakeVersionInfoAsync(count int32) FutureGetStakeVersionInfoResult {
	cmd := fnojson.NewGetStakeVersionInfoCmd(count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) GetStakeVersionInfo(count int32) (*fnojson.GetStakeVersionInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionInfoResult) Receive() (*fnojson.GetStakeVersionInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a fnojson.GetStakeVersionInfoResult.
	var gsvr fnojson.GetStakeVersionInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeVersionsAsync(hash string, count int32) FutureGetStakeVersionsResult {
	cmd := fnojson.NewGetStakeVersionsCmd(hash, count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) GetStakeVersions(hash string, count int32) (*fnojson.GetStakeVersionsResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetTicketPoolValueResult) Receive() (fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetTicketPoolValueAsync() FutureGetTicketPoolValueResult {
	cmd := fnojson.NewGetTicketPoolValueCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) GetTicketPoolValue() (fnoutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetVoteInfoResult) Receive() (*fnojson.GetVoteInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a fnojson.GetVoteInfoResult.
	var gsvr fnojson.GetVoteInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetVoteInfoAsync(version uint32) FutureGetVoteInfoResult {
	cmd := fnojson.NewGetVoteInfoCmd(version)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnod extension.
func (c *Client) GetVoteInfo(version uint32) (*fnojson.GetVoteInfoResult, error) {
...
func (r FutureListAddressTransactionsResult) Receive() ([]fnojson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a fnod extension.
func (c *Client) ListAddressTransactionsAsync(addresses []fnoutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := fnojson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a fnowallet extension.
func (c *Client) ListAddressTransactions(addresses []fnoutil.Address, account string) ([]fnojson.ListTransactionsResult, error) {
...
func (r FutureLiveTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a fnojson.LiveTicketsResult.
	var container fnojson.LiveTicketsResult
...
func (r FutureMissedTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a fnojson.MissedTicketsResult.
	var container fnojson.MissedTicketsResult
	err = json.Unmarshal(res, &container)
	if err != nil {
		return nil, err
	}
...
func (c *Client) MissedTicketsAsync() FutureMissedTicketsResult {
	cmd := fnojson.NewMissedTicketsCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*fnojson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session fnojson.SessionResult
...
//
// NOTE: This is a Fonero extension.
...
//
// NOTE: This is a Fonero extension.
func (c *Client) Session() (*fnojson.SessionResult, error) {
...
func (r FutureTicketFeeInfoResult) Receive() (*fnojson.TicketFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir fnojson.TicketFeeInfoResult
...
func (c *Client) TicketFeeInfoAsync(blocks *uint32, windows *uint32) FutureTicketFeeInfoResult {
	...
	cmd := fnojson.NewTicketFeeInfoCmd(blocks, windows)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Fonero extension.
func (c *Client) TicketFeeInfo(blocks *uint32, windows *uint32) (*fnojson.TicketFeeInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the
// ticketvwap result.
func (r FutureTicketVWAPResult) Receive() (fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amt, err := fnoutil.NewAmount(vwap)
	if err != nil {
		return 0, err
	}
...
func (c *Client) TicketVWAPAsync(start *uint32, end *uint32) FutureTicketVWAPResult {
	...
	cmd := fnojson.NewTicketVWAPCmd(start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Fonero extension.
func (c *Client) TicketVWAP(start *uint32, end *uint32) (fnoutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the
// txfeeinfo result.
func (r FutureTxFeeInfoResult) Receive() (*fnojson.TxFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir fnojson.TxFeeInfoResult
	err = json.Unmarshal(res, &tfir)
	if err != nil {
		return nil, err
	}
...
func (c *Client) TxFeeInfoAsync(blocks *uint32, start *uint32, end *uint32) FutureTxFeeInfoResult {
	...
	cmd := fnojson.NewTxFeeInfoCmd(blocks, start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Fonero extension.
func (c *Client) TxFeeInfo(blocks *uint32, start *uint32, end *uint32) (*fnojson.TxFeeInfoResult, error) {
...
// result.
func (r FutureVersionResult) Receive() (map[string]fnojson.VersionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr map[string]fnojson.VersionResult
	err = json.Unmarshal(res, &vr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) VersionAsync() FutureVersionResult {
	cmd := fnojson.NewVersionCmd()
	return c.sendCmd(cmd)
}

// Version returns information about the server's JSON-RPC API versions.
func (c *Client) Version() (map[string]fnojson.VersionResult, error) {
