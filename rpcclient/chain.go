...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := fnojson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := fnojson.NewGetBlockCmd(hash, fnojson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*fnojson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult fnojson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash, verboseTx bool) FutureGetBlockVerboseResult {
	...
	cmd := fnojson.NewGetBlockCmd(hash, fnojson.Bool(true), &verboseTx)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash, verboseTx bool) (*fnojson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := fnojson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := fnojson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockChainInfoResult) Receive() (*fnojson.GetBlockChainInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockchainInfoRes fnojson.GetBlockChainInfoResult
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := fnojson.NewGetBlockChainInfoCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := fnojson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(hash *chainhash.Hash) FutureGetBlockHeaderResult {
	cmd := fnojson.NewGetBlockHeaderCmd(hash.String(), fnojson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*fnojson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var bh fnojson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(hash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	cmd := fnojson.NewGetBlockHeaderCmd(hash.String(), fnojson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockSubsidyResult) Receive() (*fnojson.GetBlockSubsidyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal the result
	var bs fnojson.GetBlockSubsidyResult
...
func (c *Client) GetBlockSubsidyAsync(height int64, voters uint16) FutureGetBlockSubsidyResult {
	cmd := fnojson.NewGetBlockSubsidyCmd(height, voters)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// current coin supply
func (r FutureGetCoinSupplyResult) Receive() (fnoutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetCoinSupplyAsync() FutureGetCoinSupplyResult {
	cmd := fnojson.NewGetCoinSupplyCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolAsync(txType fnojson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolResult {
	cmd := fnojson.NewGetRawMempoolCmd(fnojson.Bool(false),
		fnojson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempool(txType fnojson.GetRawMempoolTxTypeCmd) ([]*chainhash.Hash, error) {
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]fnojson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]fnojson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync(txType fnojson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolVerboseResult {
	cmd := fnojson.NewGetRawMempoolCmd(fnojson.Bool(true),
		fnojson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose(txType fnojson.GetRawMempoolTxTypeCmd) (map[string]fnojson.GetRawMempoolVerboseResult, error) {
...
func (r FutureGetChainTipsResult) Receive() ([]fnojson.GetChainTipsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal the result.
	var chainTips []fnojson.GetChainTipsResult
...
func (c *Client) GetChainTipsAsync() FutureGetChainTipsResult {
	cmd := fnojson.NewGetChainTipsCmd()
	return c.sendCmd(cmd)
}

// GetChainTips returns all known tips in the block tree.
func (c *Client) GetChainTips() ([]fnojson.GetChainTipsResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := fnojson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int64) FutureVerifyChainResult {
	cmd := fnojson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int64) FutureVerifyChainResult {
	cmd := fnojson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*fnojson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *fnojson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := fnojson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*fnojson.GetTxOutResult, error) {
...
func (r FutureRescanResult) Receive() (*fnojson.RescanResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanResult *fnojson.RescanResult
...
func (c *Client) RescanAsync(blockHashes []chainhash.Hash) FutureRescanResult {
	...
	cmd := fnojson.NewRescanCmd(hex.EncodeToString(concatenatedBlockHashes))
	return c.sendCmd(cmd)
}
...
func (c *Client) Rescan(blockHashes []chainhash.Hash) (*fnojson.RescanResult, error) {
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterResult {
	...
	cmd := fnojson.NewGetCFilterCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterHeaderResult {
	...
	cmd := fnojson.NewGetCFilterHeaderCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
