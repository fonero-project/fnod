...
// MsgBlock implements the Message interface and represents a fnocoin
...
// BtcDecode decodes from the Fonero wire protocol as it was sent across the
...
// the Fonero wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Fonero block message that conforms to the
