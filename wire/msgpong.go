...
// MsgPong implements the Message interface and represents a Fonero pong
// message which is used primarily to confirm that a connection is still valid
// in response to a Fonero ping message (MsgPing).
//
...
// NewMsgPong returns a new Fonero pong message that conforms to the Message
