...
// maxNetAddressPayload returns the max payload size for a Fonero NetAddress
...
type NetAddress struct {
	...
	// not present in the Fonero version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Fonero protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Fonero protocol mixes little and big endian.
