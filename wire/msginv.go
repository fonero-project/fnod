...
// MsgInv implements the Message interface and represents a Fonero inv message.
...
// NewMsgInv returns a new Fonero inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Fonero inv message that conforms to the
