...
const (
	...
	InvTypeCodechainEntry InvType = 256 // Fonero updater
	InvTypePatch          InvType = 257 // Fonero updater
)
...
// InvVect defines a Fonero inventory vector which is used to describe data,
