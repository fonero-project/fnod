...
const DefaultUserAgent = "/fnowire:0.3.0/"

// MsgVersion implements the Message interface and represents a Fonero version
...
// NewMsgVersion returns a new Fonero version message that conforms to the
...
// and local address from conn and returns a new Fonero version message that
