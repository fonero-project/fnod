...
// MsgMemPool implements the Message interface and represents a Fonero mempool
...
// NewMsgMemPool returns a new Fonero pong message that conforms to the Message
