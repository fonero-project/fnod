...
// BlockHeader defines information about a block and is used in the fnocoin
...
// readBlockHeader reads a Fonero block header from r.  See Deserialize for
...
// writeBlockHeader writes a Fonero block header to w.  See Serialize for
