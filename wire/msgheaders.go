...
// a single Fonero headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Fonero headers
...
// NewMsgHeaders returns a new Fonero headers message that conforms to the
