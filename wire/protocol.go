...
// ServiceFlag identifies services supported by a Fonero peer.
...
// CurrencyNet represents which Fonero network a message belongs to.
type CurrencyNet uint32

// Constants used to indicate the message Fonero network.  They can also be
// used to seek to the next message when a stream's state is unknown, but
// this package does not provide that functionality since it's generally a
// better idea to simply disconnect clients that are misbehaving over TCP.
const (
	// MainNet represents the main Fonero network.
	...
	TestNet CurrencyNet = 0x506f6f0c

	// SimNet represents the simulation test network.
	SimNet CurrencyNet = 0x3f78f517
)

// bnStrings is a map of Fonero networks back to their constant names for
// pretty printing.
