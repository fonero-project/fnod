...
// MsgReject implements the Message interface and represents a Fonero reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Fonero protocol does not enforce a sane
...
// NewMsgReject returns a new Fonero reject message that conforms to the
