...
// arguments returns an array of arguments that be used to launch the fnod
// process.
...
// to the fnod process that is launched via Start().
...
func (n *node) start() error {
	...
	pid, err := os.Create(filepath.Join(n.config.String(), "fnod.pid"))
	if err != nil {
		return err
	}
...
// stop interrupts the running fnod process process, and waits until it exits
...
// shutdown terminates the running fnod process, and cleans up all
