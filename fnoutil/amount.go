...
// units, "1eN FNO" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " FNO"
	}
}
...
//
// NewAmount is for specifically for converting FNO to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/fonero-project/fnod/fnoutil#example-Amount
...
// useful for services that build on top of Fonero (for example, calculating
