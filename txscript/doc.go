...
Fonero transaction scripts are written in a stack-base, FORTH-like language.

The Fonero script language consists of a number of opcodes which fall into
...
The vast majority of Fonero scripts at the time of this writing are of several
