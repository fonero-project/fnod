...
/*
Package addrmgr implements concurrency safe Fonero address manager.

Address Manager Overview

In order maintain the peer-to-peer Fonero network, there needs to be a source
of addresses to connect to as nodes come and go.  The Fonero protocol provides
