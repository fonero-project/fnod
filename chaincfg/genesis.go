...
//
// The genesis block for Fonero mainnet, testnet, and simnet are not evaluated
...
var testNetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:    time.Unix(1532534303, 0), // 2018-07-25T15:58:23Z (`printunixtime`)
		Bits:         0x1e00ffff,
		SBits:        20000000,
		Nonce:        0x7f36db81, // (`gennonce`)
		StakeVersion: 0,
	},
