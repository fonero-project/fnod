...
//
// In addition to the main Fonero network, which is intended for the transfer
...
// wire.FoneroNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := fnoutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Fonero networks,
