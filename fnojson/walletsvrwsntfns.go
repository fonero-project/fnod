...
const (
	...
	DcrdConnectedNtfnMethod = "fnodconnected"
	...
	// RevocationCreatedNtfnMethod is the method of the fnowallet
	...
	// TicketPurchasedNtfnMethod is the method of the fnowallet
	// ticketpurchased notification.
	TicketPurchasedNtfnMethod = "ticketpurchased"

	// VoteCreatedNtfnMethod is the method of the fnowallet
...
// DcrdConnectedNtfn defines the fnoddconnected JSON-RPC notification.
type DcrdConnectedNtfn struct {
	Connected bool
}

// NewDcrdConnectedNtfn returns a new instance which can be used to issue a
// fnoddconnected JSON-RPC notification.
