...
//
// DEPRECATED.  This will be removed in the next major version bump of fnojson.
...
type SendManyCmd struct {
	FromAccount string
	Amounts     map[string]float64 `jsonrpcusage:"{\"address\":amount,...}"` // In FNO
	MinConf     *int               `jsonrpcdefault:"1"`
	Comment     *string
}
...
// the SignRawTransactionCmd struct.  Contains Fonero additions.
