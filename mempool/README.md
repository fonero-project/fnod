...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/fonero-project/fnod/mempool)

Package mempool provides a policy-enforced pool of unmined Fonero transactions.

A key responsibility of the Fonero network is mining transactions – regular
...
Since this package does not deal with other Fonero specifics such as network
...
package for any projects needing the ability create an in-memory pool of Fonero
...
```bash
$ go get -u github.com/fonero-project/fnod/mempool
```
