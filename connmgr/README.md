...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/fonero-project/fnod/connmgr)

Package connmgr implements a generic Fonero network connection manager.
...
```bash
$ go get -u github.com/fonero-project/fnod/connmgr
```
